...
<div className='mt-4'><Link to='/fullprofile'><img src={t3}/></Link></div>
                  ...
                  <div className='mt-[30px] ml-[50px]'><b>All Contracts</b></div>
...
<div className='ml-4 -mt-[20px]'><button><img src={Al1}/></button></div>
<div><button><img src={Al2}/></button></div>

    </div>


    <div className='border ml-[50px] mr-[50px]'>
...
<div className='ml-[100px]'><b>1 - 10 Of 12 Contracts</b></div>
<div className='ml-[800px]'><img src={Al5}/></div>
</div>
  </div>
<br/><br/><br/>
