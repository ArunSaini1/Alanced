...
<div className='mt-[40px] ml-[60px]'><br/>
    <div><b>My Reports</b></div><br/>
    <div><b>Weekly Summary</b><br/>Current Week</div><br/><br/>
    <div><b>Weekly Summary</b><br/>Current Week</div>
</div>
         ...
         <div className='flex bg-blue-100 ml-[50px] mr-[50px] mt-[50px]'>
